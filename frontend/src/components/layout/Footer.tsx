      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="mt-4 text-navy-300 text-sm">
              Your partner in data-driven innovation. Leveraging AI to transform businesses since 2023.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <h6 className="text-teal-500 font-medium mb-3">Company</h6>
              <ul className="space-y-2 text-sm">
                <li><a href="#" className="text-navy-300 hover:text-white transition-colors">About Us</a></li>
                <li><a href="#" className="text-navy-300 hover:text-white transition-colors">Our Team</a></li>
            ...
            <div>
              <h6 className="text-teal-500 font-medium mb-3">Legal</h6>
              <ul className="space-y-2 text-sm">
          ...
          {/* Newsletter */}
          <div>
            <h6 className="text-teal-500 font-medium mb-3">Subscribe to our newsletter</h6>
            <div className="flex mt-2">
              <input
                type="email"
                placeholder="Your email"
                className="rounded-l-md px-4 py-2 w-full bg-navy-800 border-none text-sm focus:outline-none focus:ring-2 focus:ring-teal-500"
              />
              <button className="bg-teal-500 text-white rounded-r-md px-4 py-2 text-sm font-medium hover:bg-teal-600 transition-colors">
                Subscribe
              </button>
            </div>
        ...
        <div className="border-t border-navy-800 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-navy-400">
            © {currentYear} TRESIDUS AI Consulting. All rights reserved.
          </p>
